...
# preflight and publisher (make release-publish) unchanged.
#
...
# Recall changelog headings drop the v-prefix: ## [X.Y.Z] - YYYY-MM-DD.
...
echo "  - publish via make release-publish (preflight, tag, workflow, tap)"
