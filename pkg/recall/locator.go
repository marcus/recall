...
type Locator struct {
	// SourceID is the configured display prefix used in human-readable locators.
	SourceID string `json:"source_id,omitempty"`
	// SourceUID is the immutable configured source identity.
	SourceUID SourceUID `json:"source_uid,omitempty"`
	// Local is the adapter-owned record reference.
...
// UnmarshalJSON parses a display-form locator.
